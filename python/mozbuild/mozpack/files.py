...
class AbsoluteSymlinkFile(File):
    ...
    def copy(self, dest, skip_if_older=True, relative=False):
        assert isinstance(dest, basestring)
        ...
        if relative:
            ...
            tgtpath = mozpath.relpath(self.path, mozpath.dirname(dest))
        else:
            tgtpath = self.path
