...
ifndef NO_INSTALL_IMPORT_LIBRARY
	...
	$(call PROCESS_SYMFILE,$(SHARED_LIBRARY),$(INSTALL) $(IFLAGS2),$(FINAL_TARGET))
endif # IS_COMPONENT
endif # SHARED_LIBRARY
ifdef PROGRAM
	$(INSTALL) $(IFLAGS2) $(PROGRAM) $(FINAL_TARGET)
	$(call PROCESS_SYMFILE,$(PROGRAM),$(INSTALL) $(IFLAGS2),$(FINAL_TARGET))
endif
ifdef SIMPLE_PROGRAMS
	$(INSTALL) $(IFLAGS2) $(SIMPLE_PROGRAMS) $(FINAL_TARGET)
	$(call PROCESS_SYMFILE,$(SIMPLE_PROGRAMS),$(INSTALL) $(IFLAGS2),$(FINAL_TARGET))
endif
ifdef HOST_PROGRAM
