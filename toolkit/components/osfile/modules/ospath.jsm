...
if (typeof Components == "undefined") {
  ...
  } else if (OS.Constants.OS2) {
    Path = require("resource://gre/modules/osfile/ospath_os2.jsm");
  } else {
  ...
  } else if (Scope.OS.Constants.OS2) {
    Cu.import("resource://gre/modules/osfile/ospath_os2.jsm", Path);
  } else {
