  ...
  (function(exports) {
     ...
     let init = function init(aDeclareFFI) {
       ...
       libc.declareLazy(SysFile, "_close",
                        libc_func("close"), ctypes.default_abi,
                        /*return */ctypes.int,
                        /*fd*/     ctypes.int);
       ...
       libc.declareLazy(SysFile, "_close_dir",
                        libc_func("closedir"), ctypes.default_abi,
                        /*return */ctypes.int,
       ...
       libc.declareLazyFFI(SysFile,  "access",
                           libc_func("access"), ctypes.default_abi,
                           /*return*/ Type.negativeone_or_nothing,
                           /*path*/   Type.path,
                           /*mode*/   Type.int);

       libc.declareLazyFFI(SysFile,  "chdir",
                           libc_func("chdir"), ctypes.default_abi,
                           /*return*/ Type.negativeone_or_nothing,
                           /*path*/   Type.path);

       libc.declareLazyFFI(SysFile,  "chmod",
                           libc_func("chmod"), ctypes.default_abi,
                           /*return*/ Type.negativeone_or_nothing,
                           /*path*/   Type.path,
                           /*mode*/   Type.mode_t);

       libc.declareLazyFFI(SysFile,  "chown",
                           libc_func("chown"), ctypes.default_abi,
                           /*return*/ Type.negativeone_or_nothing,
                           /*path*/   Type.path,
                           /*uid*/    Type.uid_t,
                           /*gid*/    Type.gid_t);
       ...
       libc.declareLazyFFI(SysFile,  "copyfile",
                           libc_func("copyfile"), ctypes.default_abi,
                           /*return*/ Type.negativeone_or_nothing,
                           /*source*/ Type.path,
                           /*dest*/   Type.path,
       ...
       libc.declareLazyFFI(SysFile,  "dup",
                           libc_func("dup"), ctypes.default_abi,
       ...
       if ("OSFILE_SIZEOF_DIR" in Const) {
         ...
         libc.declareLazyFFI(SysFile,  "dirfd",
                             libc_func("dirfd"), ctypes.default_abi,
                             /*return*/ Type.negativeone_or_fd,
                             /*dir*/    Type.DIR.in_ptr);
       }
       ...
       libc.declareLazyFFI(SysFile,  "fchdir",
                           libc_func("fchdir"), ctypes.default_abi,
                           /*return*/ Type.negativeone_or_nothing,
                           /*fd*/     Type.fd);

       libc.declareLazyFFI(SysFile,  "fchmod",
                           libc_func("fchmod"), ctypes.default_abi,
                           /*return*/ Type.negativeone_or_nothing,
                           /*fd*/     Type.fd,
                           /*mode*/   Type.mode_t);

       libc.declareLazyFFI(SysFile,  "fchown",
                           libc_func("fchown"), ctypes.default_abi,
                           /*return*/ Type.negativeone_or_nothing,
                           /*fd*/     Type.fd,
                           /*uid_t*/  Type.uid_t,
                           /*gid_t*/  Type.gid_t);
       ...
       libc.declareLazyFFI(SysFile,  "fsync",
                           libc_func("fsync"), ctypes.default_abi,
                           /*return*/ Type.negativeone_or_nothing,
                           /*fd*/     Type.fd);

       libc.declareLazyFFI(SysFile,  "getcwd",
                           libc_func("getcwd"), ctypes.default_abi,
                           /*return*/ Type.out_path,
                           /*buf*/    Type.out_path,
                           /*size*/   Type.size_t);

       libc.declareLazyFFI(SysFile,  "getwd",
                           libc_func("getwd"), ctypes.default_abi,
                           /*return*/ Type.out_path,
                           /*buf*/    Type.out_path);
       ...
       libc.declareLazyFFI(SysFile,  "get_current_dir_name",
                           libc_func("get_current_dir_name"), ctypes.default_abi,
       ...
       libc.declareLazyFFI(SysFile,  "fdatasync",
                           libc_func("fdatasync"), ctypes.default_abi,
                           /*return*/ Type.negativeone_or_nothing,
                           /*fd*/     Type.fd); // Note: MacOS/BSD-specific

       libc.declareLazyFFI(SysFile,  "ftruncate",
                           libc_func("ftruncate"), ctypes.default_abi,
                           /*return*/ Type.negativeone_or_nothing,
                           /*fd*/     Type.fd,
                           /*length*/ Type.off_t);
       ...
       libc.declareLazyFFI(SysFile,  "lchown",
                           libc_func("lchown"), ctypes.default_abi,
                           /*return*/ Type.negativeone_or_nothing,
                           /*path*/   Type.path,
                           /*uid_t*/  Type.uid_t,
                           /*gid_t*/  Type.gid_t);
       ...
       libc.declareLazyFFI(SysFile,  "link",
                           libc_func("link"), ctypes.default_abi,
                           /*return*/ Type.negativeone_or_nothing,
                           /*source*/ Type.path,
                           /*dest*/   Type.path);

       libc.declareLazyFFI(SysFile,  "lseek",
                           libc_func("lseek"), ctypes.default_abi,
                           /*return*/ Type.off_t,
                           /*fd*/     Type.fd,
                           /*offset*/ Type.off_t,
                           /*whence*/ Type.int);
       ...
       libc.declareLazyFFI(SysFile,  "mkdir",
                           libc_func("mkdir"), ctypes.default_abi,
                           /*return*/ Type.int,
                           /*path*/ Type.path,
                           /*mode*/ Type.int);

       libc.declareLazyFFI(SysFile,  "mkstemp",
                           libc_func("mkstemp"), ctypes.default_abi,
                           /*return*/   Type.fd,
                           /*template*/ Type.out_path);

       libc.declareLazyFFI(SysFile,  "open",
                           libc_func("open"), ctypes.default_abi,
                           /*return*/ Type.negativeone_or_fd,
                           /*path*/   Type.path,
                           /*oflags*/ Type.int,
                           /*mode*/   Type.int);
       ...
       if (OS.Constants.Sys.Name == "NetBSD") {
          libc.declareLazyFFI(SysFile,  "opendir",
                              libc_func("__opendir30"), ctypes.default_abi,
                   /*return*/ Type.null_or_DIR_ptr,
                   /*path*/   Type.path);
       } else {
          libc.declareLazyFFI(SysFile,  "opendir",
                              libc_func("opendir"), ctypes.default_abi,
                    /*return*/ Type.null_or_DIR_ptr,
                    /*path*/   Type.path);
       }

       libc.declareLazyFFI(SysFile,  "pread",
                               libc_func("pread"), ctypes.default_abi,
       ...
       libc.declareLazyFFI(SysFile,  "pwrite",
                               libc_func("pwrite"), ctypes.default_abi,
                    /*return*/ Type.negativeone_or_ssize_t,
                    /*fd*/     Type.fd,
       ...
       libc.declareLazyFFI(SysFile,  "read",
                              libc_func("read"), ctypes.default_abi,
                    /*return*/Type.negativeone_or_ssize_t,
                    /*fd*/    Type.fd,
                    /*buf*/   Type.void_t.out_ptr,
                    /*nbytes*/Type.size_t);
       ...
       libc.declareLazyFFI(SysFile,  "posix_fadvise",
                               libc_func("posix_fadvise"), ctypes.default_abi,
                    /*return*/ Type.int,
                    /*fd*/     Type.fd,
                    /*offset*/ Type.off_t,
                    /*len*/    Type.off_t,
       ...
       libc.declareLazyFFI(SysFile,  "splice",
                               libc_func("splice"), ctypes.default_abi,
                    /*return*/ Type.long,
                    /*fd_in*/  Type.fd,
       ...
       libc.declareLazyFFI(SysFile,  "statvfs",
                               libc_func("statvfs"), ctypes.default_abi,
                    /*return*/ Type.negativeone_or_nothing,
                    /*path*/   Type.path,
                    /*buf*/    Type.statvfs.out_ptr); // Other platforms

       libc.declareLazyFFI(SysFile,  "symlink",
                               libc_func("symlink"), ctypes.default_abi,
                    /*return*/ Type.negativeone_or_nothing,
                    /*source*/ Type.path,
                    /*dest*/   Type.path);

       libc.declareLazyFFI(SysFile,  "truncate",
                              libc_func("truncate"), ctypes.default_abi,
                    /*return*/Type.negativeone_or_nothing,
                    /*path*/  Type.path,
                    /*length*/ Type.off_t);

       libc.declareLazyFFI(SysFile,  "unlink",
                           libc_func("unlink"), ctypes.default_abi,
                    /*return*/ Type.negativeone_or_nothing,
                    /*path*/ Type.path);

       libc.declareLazyFFI(SysFile,  "write",
                           libc_func("write"), ctypes.default_abi,
                    /*return*/ Type.negativeone_or_ssize_t,
                    /*fd*/     Type.fd,
                    /*buf*/    Type.void_t.in_ptr,
                    /*nbytes*/ Type.size_t);
       ...
       if (Const._DARWIN_FEATURE_64_BIT_INODE) {
         ...
         libc.declareLazyFFI(SysFile,  "stat",
                             libc_func("stat$INODE64"), ctypes.default_abi,
                      /*return*/ Type.negativeone_or_nothing,
                      /*path*/   Type.path,
                      /*buf*/    Type.stat.out_ptr
                     );
         libc.declareLazyFFI(SysFile,  "lstat",
                             libc_func("lstat$INODE64"), ctypes.default_abi,
                      /*return*/ Type.negativeone_or_nothing,
                      /*path*/   Type.path,
                      /*buf*/    Type.stat.out_ptr
                     );
         libc.declareLazyFFI(SysFile,  "fstat",
                             libc_func("fstat$INODE64"), ctypes.default_abi,
                      /*return*/ Type.negativeone_or_nothing,
                      /*path*/   Type.fd,
                      /*buf*/    Type.stat.out_ptr
                     );
         ...
         libc.declareLazyFFI(Stat,  "xstat",
                             libc_func(xstat_name), ctypes.default_abi,
                      /*return*/    Type.negativeone_or_nothing,
                      /*_stat_ver*/ Type.int,
                      /*path*/      Type.path,
                      /*buf*/       Type.stat.out_ptr);
         libc.declareLazyFFI(Stat,  "lxstat",
                             libc_func(lxstat_name), ctypes.default_abi,
                      /*return*/    Type.negativeone_or_nothing,
                      /*_stat_ver*/ Type.int,
                      /*path*/      Type.path,
                      /*buf*/       Type.stat.out_ptr);
         libc.declareLazyFFI(Stat, "fxstat",
                             libc_func(fxstat_name), ctypes.default_abi,
                      /*return*/    Type.negativeone_or_nothing,
                      /*_stat_ver*/ Type.int,
                      /*fd*/        Type.fd,
                      /*buf*/       Type.stat.out_ptr);
         ...
         libc.declareLazyFFI(SysFile,  "stat",
                            libc_func( "__stat50"), ctypes.default_abi,
                      /*return*/ Type.negativeone_or_nothing,
                      /*path*/   Type.path,
                      /*buf*/    Type.stat.out_ptr
                     );
         libc.declareLazyFFI(SysFile,  "lstat",
                             libc_func("__lstat50"), ctypes.default_abi,
                      /*return*/ Type.negativeone_or_nothing,
                      /*path*/   Type.path,
                      /*buf*/    Type.stat.out_ptr
                     );
         libc.declareLazyFFI(SysFile,  "fstat",
                             libc_func("__fstat50"), ctypes.default_abi,
                      /*return*/ Type.negativeone_or_nothing,
                      /*fd*/     Type.fd,
                      /*buf*/    Type.stat.out_ptr
                     );
         ...
         libc.declareLazyFFI(SysFile,  "stat",
                             libc_func("stat"), ctypes.default_abi,
                      /*return*/ Type.negativeone_or_nothing,
                      /*path*/   Type.path,
                      /*buf*/    Type.stat.out_ptr
                     );
         libc.declareLazyFFI(SysFile,  "lstat",
                             libc_func("lstat"), ctypes.default_abi,
                      /*return*/ Type.negativeone_or_nothing,
                      /*path*/   Type.path,
                      /*buf*/    Type.stat.out_ptr
                     );
         libc.declareLazyFFI(SysFile,  "fstat",
                             libc_func("fstat"), ctypes.default_abi,
                      /*return*/ Type.negativeone_or_nothing,
                      /*fd*/     Type.fd,
                      /*buf*/    Type.stat.out_ptr
                     );
       ...
       libc.declareLazyFFI(Pipe, "_pipe",
         libc_func("pipe"), ctypes.default_abi,
         /*return*/ Type.negativeone_or_nothing,
       ...
       if (OS.Constants.Sys.Name == "NetBSD") {
           libc.declareLazyFFI(SysFile, "utimes",
                               libc_func("__utimes50"), ctypes.default_abi,
                      /*return*/     Type.negativeone_or_nothing,
                      /*path*/       Type.path,
           ...
           libc.declareLazyFFI(SysFile, "utimes",
                               libc_func("utimes"), ctypes.default_abi,
                      /*return*/     Type.negativeone_or_nothing,
                      /*path*/       Type.path,
                      /*timeval[2]*/ Type.timevals.out_ptr
                      );
       ...
       if (OS.Constants.Sys.Name == "NetBSD") {
           libc.declareLazyFFI(SysFile, "futimes",
                               libc_func("__futimes50"), ctypes.default_abi,
                      /*return*/     Type.negativeone_or_nothing,
                      /*fd*/         Type.fd,
                      /*timeval[2]*/ Type.timevals.out_ptr
                      );
           ...
           libc.declareLazyFFI(SysFile, "futimes",
                               libc_func("futimes"), ctypes.default_abi,
                      /*return*/     Type.negativeone_or_nothing,
                      /*fd*/         Type.fd,
                      /*timeval[2]*/ Type.timevals.out_ptr
                      );
